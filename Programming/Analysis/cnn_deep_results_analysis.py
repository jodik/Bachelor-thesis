...
def add(lines):
    ...
    for i in range(len(lines)):
        ...
        cst = my_split('CONV_THIRD_DEPTH = ', line, cst)
    ...
    return (simplified, hard_difficulty, border, extended_dataset, scale), [val_err, lr, dc, fc1, m, time, dp, cfs, cff, csf, cfd, csd, cst, vf]

out_index_folder = 'Learning/CNN/results/default_deep_3/full_cv/'
